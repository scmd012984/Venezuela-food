...
export function BottomNav() {
  ...
  return (
    <nav className="pb-safe fixed bottom-0 left-0 z-50 flex w-full justify-around rounded-t-3xl border-t border-outline-variant/50 bg-white/96 px-2 pt-2 shadow-[0_1px_0_rgba(255,255,255,0.9)_inset,0_-10px_36px_-14px_rgba(12,36,99,0.1),0_-4px_16px_-8px_rgba(28,29,38,0.08)] backdrop-blur-xl backdrop-saturate-125 dark:border-slate-600/50 dark:bg-slate-950/96 dark:shadow-[0_1px_0_rgba(255,255,255,0.05)_inset,0_-12px_32px_-8px_rgba(0,0,0,0.4)] md:hidden">
      <div className="tap-highlight-none flex min-w-[3.5rem] flex-col items-center justify-center rounded-2xl px-2 py-1.5 text-primary transition duration-200 hover:bg-primary/10 active:scale-95 dark:text-blue-300 dark:hover:bg-primary/15">
      ...
      <div className="tap-highlight-none flex min-w-[3.5rem] flex-col items-center justify-center rounded-2xl px-2 py-1.5 text-on-surface-variant/75 transition duration-200 hover:bg-primary/8 hover:text-primary active:scale-95">
